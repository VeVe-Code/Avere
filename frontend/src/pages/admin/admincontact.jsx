  ...
  return (
    <section className="min-h-screen bg-gray-100 px-6 py-14">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Table Header */}
        <div className="grid grid-cols-12 bg-gray-200 text-sm font-semibold text-gray-700 px-6 py-4 rounded-t-xl">
        ...
        <div className="bg-white rounded-b-xl shadow divide-y">
          ...
          {data.map((item, index) => (
            <motion.div
              ...
              className="grid grid-cols-12 px-6 py-5 items-center hover:bg-gray-50"
            >
              {/* USER */}
              ...
              {/* MESSAGE */}
              <Link to={`/admin/admincontactus/${item._id}`}>
